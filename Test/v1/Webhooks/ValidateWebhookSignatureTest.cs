...
namespace PayPal.v1.Webhooks.Test
{
    ...
    {
        private static VerifyWebhookSignature<PayPal.v1.Payments.Sale> buildRequestBody()
        {
            ...
            return (VerifyWebhookSignature<PayPal.v1.Payments.Sale>) new JsonSerializer().Decode(jsonContent, typeof(VerifyWebhookSignature<PayPal.v1.Payments.Sale>));
        }

        public static async Task<HttpResponse> verifyWebhook() {

            WebhookVerifySignatureRequest<PayPal.v1.Payments.Sale> request = new WebhookVerifySignatureRequest<PayPal.v1.Payments.Sale>();
